...
impl LegacyDelegationInteractor {
    pub async fn stake_endpoint(&mut self) {
        ...
        let rewa_amount = BigUint::<StaticApi>::from(2_000000000000000000u128);
    ...
    pub async fn unstake_endpoint(&mut self) {
        let user_address = self
            ...
            .await;
        let rewa_amount = BigUint::<StaticApi>::from(42000_000000000000000000u128);
